...
L["Dialog Immersive Frame"] = "Погружение"
...
L["Scrolling text"] = "Прокрутка текста"
...
L["Secure"] = "Безопасность"
L["In some situations, for safety, we forcibly turn on 'Dialog mode'."] = "В некоторых ситуациях для безопасности принудительно переводим рабу фрейма в режим 'Диалога'."
L["Text animation speed (Player)"] = "Скорость текстовой анимаций (Игрока)"
L["Text animation speed (NPC)"] = "Скорость текстовой анимаций (NPC)"
